 ...
 */
export async function getCatalogItemsByFilter(filterType, filterValue, attributeValue) {
    try {
        ...
        if (response.objects) {
            ...
            console.log("Sample item categoryId:", response.objects[0]?.itemData?.categoryId);
 ...
 */
export async function getItemsByCategoryIncludingSubcategories(categoryId) {
    try {
        ...
        if (uniqueItems.length > 0) {
            ...
            console.log('Item categoryId:', uniqueItems[0].itemData?.categoryId);
            
            // Print itemData structure
            const itemData = uniqueItems[0].itemData;
            if (itemData) {
                console.log('\nitemData fields:');
            ...
            console.log('  - imageIds:', uniqueItems[0].itemData?.imageIds);
            console.log('  - imageData:', uniqueItems[0].imageData);
 ...
 */
export async function getItemsByAttribute(attributeName, attributeValue) {
 ...
 */
export async function searchItemsByText(searchText) {
    try {
