			...
			<div class="search-panel">
				<div class="product-gallery">
					...
					<div class="thumbnail-row">
						{#each product.images as img (img)}
							<button
	...
	<section class="content-grid">
		<div class="events-section">
			...
			<ul style="color: var(--muted); line-height: 1.6;">
				...
				<li>Neck circumference: 18" – 22"</li>
		...
		<div class="custom-orders">
			<h3>Custom Orders</h3>
			<p>
				Want a personalized weave pattern, different alloy, or gemstone accents? Our artisans can
				craft a custom Luna Necklace tailored to your style.
			</p>
